 ...
 * @param sizeClass Classification of the screen size based on pre-defined breakpoints defined by Google, as followed in [ScreenClassifier].
 * @property dp Size of the screen in DPs (density-independent pixels).
 * @property sizeClass Classification of the screen size based on pre-defined breakpoints defined by Google, as followed in [ScreenClassifier].
 *
