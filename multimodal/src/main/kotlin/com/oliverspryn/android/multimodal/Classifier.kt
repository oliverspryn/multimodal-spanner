...
/**
 * Uses information about the device's foldable posture and the size of the
 * screen to determine what posture the screen is in and all information
...
class Classifier {
     ...
     * several possible postures, based on the information given to it about
     * the app's window.
     *
